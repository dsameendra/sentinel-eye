...
export class SettingsView {
  ...
  displayTab() {
    ...
    <section class="card"><h3>Picture &amp; behaviour</h3><div class="form">
      <div class="field"><span class="lbl">Fit</span><div class="seg" role="group" aria-label="Fit"><button data-o="fit:contain" aria-pressed="${d.fit === 'contain'}">Show whole picture</button><button data-o="fit:cover" aria-pressed="${d.fit === 'cover'}">Fill tile</button></div></div>
