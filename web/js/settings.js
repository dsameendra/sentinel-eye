...
export class SettingsView {
  ...
  displayTab() {
    ...
    <section class="card"><h3>Picture &amp; behaviour</h3><div class="form">
      <div class="field wide"><span class="lbl">Fit</span><div class="seg" role="group" aria-label="Fit"><button data-o="fit:contain" aria-pressed="${d.fit === 'contain'}">Show whole picture</button><button data-o="fit:cover" aria-pressed="${d.fit === 'cover'}">Fill tile</button></div>
        <div class="hint">Applies to both the live grid/large view and Playback. "Show whole picture" never crops (letterboxed if the shapes don't match); "Fill tile" crops to fill the space edge-to-edge.</div></div>
